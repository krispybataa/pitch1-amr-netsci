...
In 2019, bacterial AMR was directly responsible for 1.27 million deaths worldwide, with an estimated 4.95 million deaths associated with drug-resistant infections \cite{murray2022global, Ni2025BMCInfectDis}. The six dominant pathogens---\textit{Escherichia coli}, \textit{Staphylococcus aureus}, \textit{Klebsiella pneumoniae}, \textit{Streptococcus pneumoniae}, \textit{Acinetobacter baumannii}, and \textit{Pseudomonas aeruginosa}---collectively accounted for approximately 929,000 of those directly attributable deaths \cite{murray2022global, zambrano2022annrevgenet}. The burden is not equally distributed: Sub-Saharan Africa bears the highest per-capita AMR mortality (23.7 deaths per 100,000 population), while within the 27 EU/EEA countries studied here, median resistance rates differ by over 14 percentage points between the coldest and warmest country clusters, a disparity that demands mechanistic explanation beyond antibiotic consumption alone.

The canonical drivers of AMR are well-established: the inappropriate and excessive use of antibiotics in human medicine and agriculture remains the primary selective force for resistance. Resistance is further shaped by socioeconomic conditions, population density, healthcare infrastructure, and access to clean water and sanitation \cite{Ni2025BMCInfectDis}. Despite this understanding, containment efforts have been only partially effective, resistance continues to rise globally, even in countries with robust stewardship frameworks. This gap between known drivers and observed resistance trends suggests that environmental factors which, historically the least studied arm of the One Health framework, may be exerting an underappreciated influence. Among these, rising ambient temperature stands out as biologically plausible and epidemiologically correlated with resistance rates.
